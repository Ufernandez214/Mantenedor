...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Mantenedor Usuarios">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar--> 
    <header class="app-header"><a class="app-header__logo " href="<?= base_url(); ?>/dashboard"><i class="fas fa-cogs" style="font-size: 16px;"></i> Mantenedor Usuarios</a>
